export CFG_FILE=../projects/catlip/image_classification/food200/vit_base.yaml
export result_file=/ML-A100/team/mm/models/catlip_data/catlip_vit_base/food200
