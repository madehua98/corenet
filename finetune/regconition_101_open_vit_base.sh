export CFG_FILE=../projects/catlip/image_classification/food101/openvit_base.yaml
export result_file=/ML-A100/team/mm/models/catlip_data/open_vit_base/food101
