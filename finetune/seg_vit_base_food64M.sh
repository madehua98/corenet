export CFG_FILE=../projects/catlip/semantic_segmentation/seg/vit_base_food64M.yaml
export detection_results=/ML-A100/team/mm/models/catlip_data/results_vit_base/seg
