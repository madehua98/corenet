...
根据文本生成词表
"""
# images = get_origin_data('/ML-A100/team/mm/models/datacomp_1b/threshold_record.jsonl', 5)
...
def process_files(text_paths, output_file, num_threads=64):
    texts = []
...
output_file = '/ML-A100/team/mm/models/catlip_data/cache/captions.jsonl'
...
# # 示例使用
# directorys = "/ML-A100/team/mm/models/catlip_data/cache/"
# backup_directory = os.path.join(directorys, '2906')
