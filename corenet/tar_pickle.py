...
# 获取当前目录和目标目录
current_directory = '/ML-A100/team/mm/models/catlip_data/cache'
output_directory = '/ML-A100/team/mm/models/catlip_data/datacomp_tar'
...
def create_tar_file(task):
    index, chunk = task
    tar_filename = os.path.join(output_directory, f'datacomp_{index}.tar')
