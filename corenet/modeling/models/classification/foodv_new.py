...
from corenet.modeling.models.classification.config.foodv_new import get_configuration
...
@MODEL_REGISTRY.register(name="foodv_new", type="classification")
class Foodv(BaseImageEncoder):
    ...
    def add_arguments(cls, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        if cls == Foodv:
            ...
            group.add_argument(
                "--model.classification.foodv_new.mode",
                type=str,
                default="small",
            ...
            group.add_argument(
                "--model.classification.foodv_new.connector_type",
                type=str,
                default="dci",
                choices=["sci", "dci"],
            ...
            group.add_argument(
                "--model.classification.foodv_new.dropout",
                type=float,
                default=0.0,
            ...
            group.add_argument(
                "--model.classification.foodv_new.stochastic-dropout",
                type=float,
                default=0.0,
            ...
            group.add_argument(
                "--model.classification.foodv_new.norm-layer",
                type=str,
                default="layer_norm",
            ...
            group.add_argument(
                "--model.classification.foodv_new.sinusoidal-pos-emb",
                action="store_true",
                default=False,
                help="Use sinusoidal instead of learnable positional embedding. Defaults to False.",
            )
            group.add_argument(
                "--model.classification.foodv_new.no-cls-token",
                action="store_true",
                default=False,
            ...
            group.add_argument(
                "--model.classification.foodv_new.use-simple-fpn",
                action="store_true",
                default=False,
                help="Add simple FPN for down-stream tasks (e.g., detection). Defaults to False.",
            )
            group.add_argument(
                "--model.classification.foodv_new.use-flash-attention",
                action="store_true",
                default=False,
