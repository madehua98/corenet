...
# # 定义原始目录和目标目录
# source_directory = '/ML-A100/team/mm/models/food200/images'
# target_directory = '/ML-A100/team/mm/models/food200/test_images'

# # 确保目标目录存在
# os.makedirs(target_directory, exist_ok=True)

# # 读取txt文件路径
# txt_file = '/ML-A100/team/mm/models/food200/metadata/test_finetune_v2.txt'
...
filename = '/ML-A100/team/mm/models/food200/recognition/train_IngreLabel.jsonl'
train_datas = load_jsonl(filename)
root_path = '/ML-A100/team/mm/models/food200/images'
filename_new = '/ML-A100/team/mm/models/food200/recognition/train_IngreLabel_new.jsonl'
new_datas = []
from PIL import Image
for data in train_datas:
    try:
        Image.open(os.path.join(root_path, list(data.keys())[0])).convert("RGB")
    except:
        print(data)
